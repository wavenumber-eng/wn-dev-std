...
from wn_dev_std.cli.commands import requirement_list, requirement_show
...
def register(subparsers: SubparserRegistry) -> None:
    ...
    parser = subparsers.add_parser(
        "requirement",
        help="Read compliant requirements",
        description="Read compliant Wavenumber requirement documents.",
    )
