...
MIXED_MODE_RULES = (
    ...
    StrictRule(
        "workflow.native",
        "Bazel preferred; CMake + CTest permitted",
        "Prefer one scalable hermetic graph while retaining a portable compatibility path.",
    ),
    ...
    StrictRule(
        "version-sync",
        "package, Bazel/CMake, CLI, ABI",
        "Prevent mismatched Python/native/runtime releases.",
    ),
    StrictRule(
        "test-runner",
        "rack + pytest + bazel test or ctest",
        "Cover Python and native strata.",
    ),
...
CPP_RULES = (
    StrictRule(
        "build-system",
        "Bazel preferred; CMake permitted",
        "Greenfield native graphs prefer Bazel; maintained CMake projects remain conforming.",
    ),
    StrictRule(
        "bazel",
        "Bzlmod + pinned Bazel + locked module graph",
        "MODULE.bazel, its lockfile, .bazelversion, and .bazelrc make builds reviewable.",
    ),
    StrictRule(
        "cmake.compatibility",
        "CMakePresets.json + Ninja",
        "Permitted CMake projects retain repeatable configure, build, and test lanes.",
    ),
    StrictRule(
        "compile-commands",
        "generated by Bazel lane or CMAKE_EXPORT_COMPILE_COMMANDS=ON",
        "Clang-tidy and editor tooling need the selected build graph's compiler arguments.",
    ),
    ...
    StrictRule(
        "test-runner",
        "bazel test preferred; ctest permitted",
        "Register native tests in the selected build graph.",
    ),
